...
1.  Place your Google Service Account key as `gym-credentials.json` in the root directory.
2.  Create a Google Sheet and share it with the email address found in your service account JSON.
3.  The app will automatically create a sheet named "The Tkay Challenge" if it doesn't exist.
